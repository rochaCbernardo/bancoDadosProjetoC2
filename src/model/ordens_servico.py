...
class OrdemServico:
    def __init__(self,
                 ...
                 cod_peca_utilizada: PecaUtilizada = None,
    ...
    def set_cod_peca_utilizada(self, cod_peca_utilizada: PecaUtilizada):
        self.cod_peca_utilizada = cod_peca_utilizada
    ...
    def get_cod_peca_utilizada(self) -> PecaUtilizada:
